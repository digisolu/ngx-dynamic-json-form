...
function generateOutput(dataArray) {
  ...
  var output =
    "## Test Coverage for: ngx-dynamic-json-form-" +
    mode +
    ": " +
    toPercent(totalFound, totalHits) +
    "\n\n";

  output += "This Report is autogenerated and shows the Test coverage for the lib.\n\n";
  output += "### Included files:\n\n";
  output +=
    '<div className="scroll-container"><table width="100%"><thead><tr><th align="left">File</th><th align="left">Lines</th><th align="left">Functions</th><th align="left">Branches</th><th align="left">Coverage File</th></tr></thead><tbody>';
  output += tableRows;
