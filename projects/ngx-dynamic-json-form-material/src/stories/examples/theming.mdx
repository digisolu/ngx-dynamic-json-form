...
More information about global configurations can be found in the [global configuration section](?path=/docs/guides-global-configurations--documentation).
...
`ndf-input`, `ndf-select`, `ndf-form-field` etc.
