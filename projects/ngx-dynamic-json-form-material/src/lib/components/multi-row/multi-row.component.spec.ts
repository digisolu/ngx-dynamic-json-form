    ...
    [
      {
        ...
        result: {
          ...
          buttonTooltip: null,
          buttonType: null,
          className: 'ndf-mat-multi-row-button ndf-add-button',
          disabled: false,
          type: 'button',
          variant: null,
        },
      ...
      },
      {
        ...
        result: {
          ...
          buttonType: 'submit',
          className: 'ndf-mat-multi-row-button ndf-add-button my-class',
          disabled: true,
          type: 'button',
      ...
      },
      {
        ...
        result: {
          ...
          buttonTooltip: 'My Tooltip',
          buttonType: 'submit',
          className: 'ndf-mat-multi-row-button ndf-add-button my-class-default',
          disabled: true,
          type: 'button',
          variant: 'mat-raised-button',
        },
